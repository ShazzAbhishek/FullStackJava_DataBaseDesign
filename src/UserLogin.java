...
//				frame.dispose();
//			} 
			if(name.equalsIgnoreCase("Abhishek") && password.equalsIgnoreCase("1234")) {
				UserSuccess.main(new String[]{});
				frame.dispose();
				}
			
			else {
				JOptionPane.showMessageDialog(UserLogin.this, "Username or password is incorrect","Login Error!", JOptionPane.ERROR_MESSAGE);
				textField.setText("");
